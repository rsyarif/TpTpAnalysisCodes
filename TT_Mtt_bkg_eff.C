#define TT_Mtt_bkg_eff_cxx
#include "TT_Mtt_bkg_eff.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void TT_Mtt_bkg_eff::Loop()
{
//   In a ROOT session, you can do:
//      root> .L TT_Mtt_bkg_eff.C
//      root> TT_Mtt_bkg_eff t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile* f1 = new TFile("TT_Mtt_bkg_eff_unmatched.root","recreate");
   gr->Write();
