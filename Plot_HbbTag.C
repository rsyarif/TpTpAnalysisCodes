{
  ...
  string cut = "FatJetInfo.Jet_pt>300&&FatJetInfo.Jet_massSoftDrop>95&&FatJetInfo.Jet_massSoftDrop<155";
  ...
  ts->Draw("FatJetInfo.Jet_DoubleSV>>h1");
  tb->Draw("FatJetInfo.Jet_DoubleSV>>h2");
  ...
  h->Add(h2,"sames");
  h->Draw("nostack");
  h->GetXaxis()->SetTitle("Hbb-tag Discriminator");
